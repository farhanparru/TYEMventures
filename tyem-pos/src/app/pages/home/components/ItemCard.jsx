...
const ItemCard = React.memo(({ selectedCategory }) => {
  ...
  const [items, setItems] = useState({ firstColumn: [], secondColumn: [], thirdColumn: [] ,fourthColumn:[]});
    ...
    const fetchItems = async () => {
      ...
      try {
        ...
        setItems({
          ...
          thirdColumn: filteredItems.slice(2 * itemsPerColumn, 3 * itemsPerColumn),
  ...
  const fourthColumnItems = useMemo(() => items.fourthColumn, [items.thirdColumn]);
