  ...
  return (
    <aside className={`fixed inset-y-0 left-0 transform ${openSidebarToggle ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-200 ease-in-out bg-purple-900 text-white w-64 z-30`}>
      ...
      <nav className="mt-10">
        ...
        <Link to="/employees" className="flex items-center py-2 px-6 text-sm text-white hover:bg-purple-700">
          <FaUsers className="mr-3" />
          Employees
        </Link>
        ...
        <Link to="/restaurant-management" className="flex items-center py-2 px-6 text-sm text-white hover:bg-purple-700">
